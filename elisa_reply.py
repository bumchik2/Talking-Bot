...
# 'pairs' were copy-pasted from internet ;)
...
eliza_chat_bot = Chat(pairs, reflections)


def get_reply(user_message):
    user_message = translate(text=user_message, source_language='auto', destination_language='en')

    return eliza_chat_bot.respond(user_message)
